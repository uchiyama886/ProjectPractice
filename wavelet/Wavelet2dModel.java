...
public class Wavelet2dModel extends WaveletModel {
  ...
  public void computeFromPoint(Point paramPoint, boolean paramBoolean) {
    for (int b = 0; b < this.sourceCoefficientsArray.length; b++) {
  ...
  public void computeRecomposedCoefficients() {
    ...
    for (int b = 0; b < this.sourceCoefficientsArray.length; b++) {
      ...
      if (arrayOfDouble != null) {
        double[][] arrayOfDouble1 = this.scalingCoefficientsArray[b];
        double[][][] arrayOfDouble2 = { this.interactiveHorizontalWaveletCoefficientsArray[b],
            this.interactiveVerticalWaveletCoefficientsArray[b], this.interactiveDiagonalWaveletCoefficientsArray[b] };
    ...
    BufferedImage bufferedImage2 = generateImage(this.interactiveHorizontalWaveletCoefficientsArray,
        maximumAbsoluteWaveletCoefficient());
    BufferedImage bufferedImage3 = generateImage(this.interactiveVerticalWaveletCoefficientsArray,
        maximumAbsoluteWaveletCoefficient());
    BufferedImage bufferedImage4 = generateImage(this.interactiveDiagonalWaveletCoefficientsArray,
        maximumAbsoluteWaveletCoefficient());
    BufferedImage bufferedImage5 = generateImage(bufferedImage1, bufferedImage2, bufferedImage3, bufferedImage4);
    BufferedImage bufferedImage6 = generateImage(this.recomposedCoefficientsArray,
        maximumAbsoluteRecomposedCoefficient());
  ...
  public static void fill(double[][] paramArrayOfdouble, double paramDouble) {
    for (int b = 0; b < paramArrayOfdouble.length; b++) {
  ...
  public static BufferedImage generateImage(BufferedImage paramBufferedImage1, BufferedImage paramBufferedImage2,
      BufferedImage paramBufferedImage3, BufferedImage paramBufferedImage4) {
    ...
    if (this.maximumAbsoluteScalingCoefficient == Double.MIN_VALUE)
      for (int b = 0; b < this.sourceCoefficientsArray.length; b++) {
        ...
        if (arrayOfDouble != null) {
          ...
          for (int b1 = 0; b1 < j; b1++) {
            for (int b2 = 0; b2 < i; b2++)
              this.maximumAbsoluteScalingCoefficient = Math.max(Math.abs(arrayOfDouble1[b2][b1]),
                  this.maximumAbsoluteScalingCoefficient);
          }
        }
      }
    ...
    if (this.maximumAbsoluteSourceCoefficient == Double.MIN_VALUE)
      for (int b = 0; b < this.sourceCoefficientsArray.length; b++) {
        ...
        if (arrayOfDouble != null) {
          ...
          for (int b1 = 0; b1 < j; b1++) {
            for (int b2 = 0; b2 < i; b2++)
              this.maximumAbsoluteSourceCoefficient = Math.max(Math.abs(arrayOfDouble[b2][b1]),
                  this.maximumAbsoluteSourceCoefficient);
          }
        }
      }
    ...
    if (this.maximumAbsoluteRecomposedCoefficient == Double.MIN_VALUE)
      for (int b = 0; b < this.sourceCoefficientsArray.length; b++) {
        ...
        if (arrayOfDouble != null) {
          ...
          for (int b1 = 0; b1 < j; b1++) {
            for (int b2 = 0; b2 < i; b2++)
              this.maximumAbsoluteRecomposedCoefficient = Math.max(Math.abs(arrayOfDouble1[b2][b1]),
                  this.maximumAbsoluteRecomposedCoefficient);
          }
        }
      }
    ...
    if (this.maximumAbsoluteWaveletCoefficient == Double.MIN_VALUE)
      for (int b = 0; b < this.sourceCoefficientsArray.length; b++) {
        ...
        if (arrayOfDouble != null) {
          ...
          for (int b1 = 0; b1 < j; b1++) {
            for (int b2 = 0; b2 < i; b2++) {
              this.maximumAbsoluteWaveletCoefficient = Math.max(Math.abs(arrayOfDouble2[b2][b1]),
                  this.maximumAbsoluteWaveletCoefficient);
              this.maximumAbsoluteWaveletCoefficient = Math.max(Math.abs(arrayOfDouble3[b2][b1]),
                  this.maximumAbsoluteWaveletCoefficient);
              this.maximumAbsoluteWaveletCoefficient = Math.max(Math.abs(arrayOfDouble4[b2][b1]),
                  this.maximumAbsoluteWaveletCoefficient);
            }
          }
        }
  ...
  public void setSourceData(double[][][] paramArrayOfdouble) {
    ...
    BufferedImage bufferedImage3 = generateImage(this.horizontalWaveletCoefficientsArray,
        maximumAbsoluteWaveletCoefficient());
    BufferedImage bufferedImage4 = generateImage(this.verticalWaveletCoefficientsArray,
        maximumAbsoluteWaveletCoefficient());
    BufferedImage bufferedImage5 = generateImage(this.diagonalWaveletCoefficientsArray,
        maximumAbsoluteWaveletCoefficient());
    BufferedImage bufferedImage6 = generateImage(this.interactiveHorizontalWaveletCoefficientsArray,
        maximumAbsoluteWaveletCoefficient());
    BufferedImage bufferedImage7 = generateImage(this.interactiveVerticalWaveletCoefficientsArray,
        maximumAbsoluteWaveletCoefficient());
    BufferedImage bufferedImage8 = generateImage(this.interactiveDiagonalWaveletCoefficientsArray,
        maximumAbsoluteWaveletCoefficient());
    ...
    BufferedImage bufferedImage11 = generateImage(this.recomposedCoefficientsArray,
        maximumAbsoluteRecomposedCoefficient());
    ...
    if (this.interactiveScalingAndWaveletCoefficientsPaneModel == null)
      this.interactiveScalingAndWaveletCoefficientsPaneModel = new WaveletPaneModel(null,
          "Interactive Scaling & Wavelet Coefficients", this);
