...
public class DiscreteWavelet2dTransformation extends DiscreteWaveletTransformation {
  ...
  protected void computeRecomposedCoefficients() {
    ...
    for (int b1 = 0; b1 < k; b1++) {
      DiscreteWavelet1dTransformation discreteWavelet1dTransformation = new DiscreteWavelet1dTransformation(
          atRow(arrayOfDouble1, b1), atRow(arrayOfDouble2, b1));
      atRowPut(arrayOfDouble5, b1, discreteWavelet1dTransformation.recomposedCoefficients());
      discreteWavelet1dTransformation = new DiscreteWavelet1dTransformation(atRow(arrayOfDouble3, b1),
          atRow(arrayOfDouble4, b1));
    ...
    for (int b2 = 0; b2 < j; b2++) {
      DiscreteWavelet1dTransformation discreteWavelet1dTransformation = new DiscreteWavelet1dTransformation(
          atRow(arrayOfDouble5, b2), atRow(arrayOfDouble6, b2));
  ...
  protected void computeScalingAndWaveletCoefficients() {
    ...
    for (int b1 = 0; b1 < i; b1++) {
      DiscreteWavelet1dTransformation discreteWavelet1dTransformation = new DiscreteWavelet1dTransformation(
          atRow(this.sourceCoefficients, b1));
  ...
  private void atRowPut(double[][] paramArrayOfdouble, int paramInt, double[] paramArrayOfdouble1) {
    for (int b = 0; b < (paramArrayOfdouble[paramInt]).length; b++)
  ...
  private double[][] transpose(double[][] paramArrayOfdouble) {
    ...
    for (int b = 0; b < paramArrayOfdouble.length; b++) {
      for (int b1 = 0; b1 < (paramArrayOfdouble[b]).length; b1++)
