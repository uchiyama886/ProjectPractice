 ...
 */
public class DiscreteWavelet1dTransformation_old extends DiscreteWaveletTransformation {
  ...
  public DiscreteWavelet1dTransformation_old(double[] paramArrayOfdouble) {
    initialize();
    sourceCoefficients(paramArrayOfdouble);
  }
  
  public DiscreteWavelet1dTransformation_old(double[] paramArrayOfdouble1, double[] paramArrayOfdouble2) {
    initialize();
