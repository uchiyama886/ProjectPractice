 ...
 * 具体的な変換ロジックは、このクラスを継承するサブクラスで実装される。
 *
...
public class WaveletTransformation extends Object {
     ...
     * @return 変換が適用された新しいWaveletTransformationインスタンス、あるいは変換後のこのインスタンス自身。
     * サブクラスの実装によって戻り値の振る舞いは異なる。
     * @throws IllegalArgumentException {@code anObject} の型が変換に適さない場合にスローされることがある。
     */
     ...
     * @return 変換が適用された新しいWaveletTransformationインスタンス。
     * @throws IllegalArgumentException {@code waveletTransformation} の型がこの変換に適さない場合にスローされることがある。
     */
