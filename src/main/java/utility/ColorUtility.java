...
public class ColorUtility extends Object
{
	...
	{
		Integer aRGB = ColorUtility.convertRGBtoINT(luminance, luminance, luminance);
	...
	{
		Integer aRGB = ColorUtility.convertRGBtoINT(r, g, b);
		Color aColor = new Color(aRGB);
		return aColor;
	}
	...
	{
		Integer red   = (int)Math.round(r * 255.0d);
		Integer green = (int)Math.round(g * 255.0d);
		Integer blue  = (int)Math.round(b * 255.0d);
		red   = (red   << 16) & 0xff0000;
