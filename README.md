...
```
git checkout -b "作業名(コミットメッセージのルールに従って書いてください)"
```
...
7. 「Create pull request」ボタンは押さないでください
    - 変更内容を確認したいので、必ず他人にレビューしてもらってください
    - 変更内容を確認してもらったら、レビューしてもらった人に「Create pull request」ボタンを押してもらってください
