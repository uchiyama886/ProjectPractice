...
public class ImageUtility {
  ...
  public static BufferedImage grayscaleImage(BufferedImage paramBufferedImage) {
    ...
    BufferedImage bufferedImage = new BufferedImage(paramBufferedImage.getWidth(), paramBufferedImage.getHeight(),
        paramBufferedImage.getType());
    for (int b = 0; b < j; b++) {
  ...
  public static BufferedImage convertYUVMatrixesToImage(double[][][] paramArrayOfdouble) {
    ...
    for (int b = 0; b < j; b++) {
      for (int b1 = 0; b1 < i; b1++) {
        double[] arrayOfDouble = ColorUtility.convertYUVtoRGB(arrayOfDouble1[b][b1], arrayOfDouble2[b][b1],
            arrayOfDouble3[b][b1]);
        int k = ColorUtility.convertRGBtoINT(arrayOfDouble);
        bufferedImage.setRGB(b1, b, k);
      }
